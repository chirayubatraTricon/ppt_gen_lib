...
class GraphBuilder(Generic[StateType]):
    ...
    def add_conditional_edges(
        self, source: str, condition: Callable[[StateType], str], path_map: dict[Hashable, str]=None
    ) -> None:
        ...
        """
        self.graph.add_conditional_edges(source=source, path=condition, path_map=path_map)
